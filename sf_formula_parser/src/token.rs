...
impl FunctionName {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::GETRECORDIDS => "GETRECORDIDS",
            ...
            Self::ISPICKVAL => "ISPICKVAL",
            Self::JSENCODE => "JSENCODE",
            Self::JSINHTMLENCODE => "JSINHTMLENCODE",
            Self::JUNCTIONIDLIST => "JUNCTIONIDLIST",
            Self::LEFT => "LEFT",
            Self::LEN => "LEN",
            Self::LINKTO => "LINKTO",
            Self::LN => "LN",
            ...
            Self::OR => "OR",
            Self::PARENTGROUPVAL => "PARENTGROUPVAL",
            Self::PREDICT => "PREDICT",
            Self::PREVGROUPVAL => "PREVGROUPVAL",
            Self::PRIORVALUE => "PRIORVALUE",
            Self::REGEX => "REGEX",
            Self::REQUIRESCRIPT => "REQUIRESCRIPT",
